...
from prettytable import PrettyTable  # Importing PrettyTable for displaying the table
...
def Add_Employee():
    ...
    # Retry mechanism to handle deadlock situations
    retries = 3
    while retries > 0:
        try:
    ...
    # If retries are exhausted, show an error message and return to the menu
    print("Unable to add employee. Please try again later.")
    press = input("Press Any Key To Continue..")
    menu()
